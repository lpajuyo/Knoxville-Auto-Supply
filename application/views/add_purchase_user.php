<div class="tab-content">
	...
	<?php echo form_open('SalesAgent/addPurchase/'.$orderID.'','id="purchase"'); //this is equal to <form method="post" accept-charset="utf-8" action="http://localhost/SalesAgent-Auto-Supply/SalesAgent/addClient">
